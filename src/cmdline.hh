...
#define CMDLINE_PARSER_PACKAGE "Spark"
#endif

#ifndef CMDLINE_PARSER_PACKAGE_NAME
/** @brief the complete program name (used for help and version) */
#define CMDLINE_PARSER_PACKAGE_NAME "Spark"
#endif
...
struct args_info
{
  ...
  int mark_candidates_flag;	/**< @brief Represent candidate base pairs by curly brackets (default=off).  */
  const char *mark_candidates_help; /**< @brief Represent candidate base pairs by curly brackets help description.  */
  ...
  int noGC_flag;	/**< @brief Turn off garbage collection and related overhead (default=off).  */

/*
  ...
  gengetopt --input=spark.ggo --c-extension=cc --header-extension=hh --arg-struct-name=args_info --unamed-opts=input
...
const char *args_info_purpose = "Time- and space-efficient sparsified minimum free energy folding of\npossibly-pseudoknotted RNAs";
...
void init_args_info(struct args_info *args_info)
{
  ...
  args_info->pk_free_help = args_info_help[4] ;
  args_info->pk_only_help = args_info_help[5] ;
  args_info->mark_candidates_help = args_info_help[6] ;
  ...
  args_info->noGC_help = args_info_help[12] ;
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "hVr:i:pkmvd:P:", long_options, &option_index);
